...
func Link(href, text string) *h.Element {
	return h.A(
		a.Props{a.Href: href},
		h.Text(text),
	)
...
func Bootstrap(title string, props a.Props, children ...h.Node) *h.Element {
	content := h.Html(a.Props{
		...
		h.Head(nil,
			...
			h.If(title != "",
				h.Title(nil, h.Text(fmt.Sprintf("%s - kradalby.no", title))),
...
func Base(title string, children ...h.Node) *h.Element {
	...
	return Bootstrap(title,
		...
		h.Footer(nil,
			h.P(nil,
				h.Text(fmt.Sprintf("Copyright © %d - Kristoffer Dalby", time.Now().Year())),
			),
		),
	)
}
...
func Instagram(size int) *h.Element {
	return h.NewElement("svg",
		a.Props{
...
func Linkedin(size int) *h.Element {
	return h.NewElement("svg",
		a.Props{
			"height":  fmt.Sprintf("%d", size),
			"width":   fmt.Sprintf("%d", size),
...
func Github(size int) *h.Element {
	return h.NewElement("svg",
		a.Props{
			"height":  fmt.Sprintf("%d", size),
			"width":   fmt.Sprintf("%d", size),
...
func Discord(size int) *h.Element {
	return h.NewElement("svg",
		a.Props{
			"height":  fmt.Sprintf("%d", size),
			"width":   fmt.Sprintf("%d", size),
...
func Twitter(size int) *h.Element {
	return h.NewElement("svg",
		a.Props{
			"height":  fmt.Sprintf("%d", size),
			"width":   fmt.Sprintf("%d", size),
